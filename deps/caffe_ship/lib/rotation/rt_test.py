...
def _get_image_blob(im):
    ...
    # print('in _get_image_blob blob size : ',blob.shape)
...
def _get_blobs(im, rois):
    ...
    if not cfg.TEST.HAS_RPN:
        ...
        # print('###################')
        # print('num1 and not RPN')
        # print("in _get_blobs and blobs['rois'] : ",blobs['rois'])
        # print('###################')
    
    # print('###################')
    # print('in _get_blobs num2')
...
def r_im_detect(net, im, boxes=None):
    ...
    # print("original image size : ( %d  %d )"%(im.shape[0],im.shape[1]))
    
    # [x _ctr, y_ctr, height, width, angle]

    blobs, im_scales = _get_blobs(im, boxes)
    
    # print("in r_im_detect and blobs['rois'] : ",blobs['rois'])
    #print("in r_im_detect and blobs['data'] : ",blobs['data'])
    ...
    ############################################################
    img_data = net.blobs['data'].data.copy()
    
    # print("blobs['data'] : ", blobs['data'])
    ...
    if cfg.TEST.HAS_RPN:
        ...
        boxes = rois[:, 1:6] / im_scales[0] # boxes ==> 0:cx, 1:cy, 2:h, 3:w, 4:angle
        
        # print('###################')
        # print('num12')
        # print('im_scales:',im_scales[0])
        # print('boxes: ',boxes)
        # print('rois: ',rois)
        # print('rois : ',rois.shape)     # (300,6)
        # print('boxes : ',boxes.shape)   # (300,5)
        # print('###################')
    ...
    if cfg.TEST.SVM:
        ...
        # print('###################')
        # print('num14')
        # print('scores : ',scores.shape)   # (300,5)
        # print('###################')
	...
	####
        ...
        # print('num15')
        # print('box_deltas : ',box_deltas.shape)  # (300,25)
        # print('pred_boxes : ',pred_boxes.shape)  # (300,25)
        # print('###################')
        ...
        # print('###################')
        # print('num16')
        # print('box_deltas : ',box_deltas.shape)
