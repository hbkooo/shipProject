...
# crontab -e
# * * * * * bash /home/hadoop/verifier/scripts/monitor.sh
# * * * * * sleep 30; bash /home/hadoop/verifier/scripts/monitor.sh

PROCESS_NAME="verifierMonitor"
PROCESS_PATH=$1 # 程序绝对路径
START_PROCESS="./${PROCESS_NAME}"
PROCESS_PARAMS=">>verifierMonitor.log &"
